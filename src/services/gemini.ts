...
export async function generateListing(productName: string, condition: string): Promise<ListingSuggestion> {
  ...
  const response = await ai.models.generateContent({
    ...
    config: {
      ...
      Your task is to help users list their items for sale.
      ...
      3. Description: Generate a detailed, accurate, and professional description. 
         ...
         - Mention key technical features if you know them for the specific product.
